...
public class MainTutorial extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateTextSize();
        tutorialText.setText(Html.fromHtml(tutorialTextArray[0]));
    }
    ...
    public void onClickBackButtonListener() {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MainTutorial.this, SearchMenu.class));
            }
        });
    }
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (currentText != tutorialTextArray.length-1){
                    /* Change text */
                    currentText += 1;
                    tutorialText.setText(Html.fromHtml(tutorialTextArray[currentText]));
                    ...
                    if (currentText == tutorialTextArray.length-1) {
                        ...
                        startActivity(new Intent(MainTutorial.this, FacebookPop.class));
                    }
                }
            }
        });
